...
const About = () => {
  return (
    <>
      <h1 className="text-6xl mb-10 font-medium text-center">About Us</h1>
      <section className="grid grid-cols-35-65  max-w-6xl m-auto justify-around items-center mb-28">
        ...
        <ul>
          ...
          >
            With a verification system for users and goods to be auctioned, this
            application can ensure that each auction is carried out fairly and
            honestly.
          </li>
          <li
            ...
            style={{ backgroundColor: "#FEC72C" }}
          >
            This auction application provides high transparency and accuracy in
            the auction process, so users can trust the final outcome of the
            auction.
          </li>
        </ul>
      </section>
